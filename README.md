...
- Böylece `FindObjectOfType<SplashController>()` çağrısı işe yarar hale gelir.
  ```cs
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            SplashController controller = FindObjectOfType<SplashController>();
  ...
  ```cs
    ...
    public class SplashController : MonoBehaviour
    {
        ...
        void Awake()
        {
            // Singleton instance oluşturuluyor
            if (_instance == null)
            {
                _instance = this;
        ...
        // Sahneye bağlı olmayan objeden ulaşmak için bu fonksiyon
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterSceneLoad)]
        private static void AutoCreate()
        {
            if (FindObjectOfType<SplashController>() == null)
            {
                GameObject obj = new GameObject("SplashController (Auto)");

                obj.AddComponent<SplashController>();
            }
        }
